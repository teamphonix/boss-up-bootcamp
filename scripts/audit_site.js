...
const requiredHtml = ['Boss Up Bootcamp', 'Join The Waitlist', '20 seats', 'showcase-grid', 'waitlist-form', 'The H.I.P.H.O.P. Academy'];
const requiredData = ['DJ Just Pray', 'Voices of the Sun', 'El Dolido', 'HospitalityOS', 'Mapify', 'Phonics Learning App'];
const errors = [];
