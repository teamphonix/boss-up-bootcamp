...
if (!adminHtml.includes('admin-event-form') || !adminJs.includes('save-event')) errors.push('Missing admin session editor.');
if (!adminJs.includes('send-confirmation-sms')) errors.push('Missing admin SMS confirmation action.');
